...
export type ConfigurationApi = {
  ...
  deleteProviderModel(hash: string, id: string, modelId: string): Promise<import('./contract').Result<void>>;
  ...
  refreshProviderModels(hash: string, id: string, apiKey?: string): Promise<import('./contract').Result<void>>;
