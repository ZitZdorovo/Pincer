...
/* ──────────────────────────────────────────────────────────────────────────
 * OpenX Tailwind design tokens
 * ──────────────────────────────────────────────────────────────────────────
 *
 * This config layers OpenX's own visual language on top of shadcn/ui:
 *
 *   1. fontFamily — OpenX uses two stacks only: one UI sans and one mono
 *      stack for technical content.
 *
 ...
 *      ...) we add three OpenX-private groups:
 ...
 *
 *   4. Naming — All OpenX-private tokens live under their own top-level
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
       ...
       * ──────────────────────────────────────────────────────────────
       *
       * Both stacks are pinned explicitly to remove dependency on Tailwind's
       * default fontFamily values. The intent:
       *
       ...
       * change only edits the values here. OpenX's full size ladder
       * (combining Tailwind defaults + OpenX additions, smallest first):
       *
       *   ┌──────────────┬──────────┬─────────────┬──────────────────────────────┐
      ...
      fontSize: {
        ...
        subtitle:   ['18px', { lineHeight: '25px' }],
        lg:         ['20px', { lineHeight: '29px' }],
       ...
       *   B. OpenX brand tokens (brand / skill) — plain hex values that
       *      do not change between light and dark themes.
       *   C. OpenX surface tokens (surface.{modal,input,sidebar}) — use
